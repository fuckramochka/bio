...
export function ProfileCard({ isPlaying }: { isPlaying: boolean }) {
  ...
  return (
    <section
      aria-label="Профиль"
      className="flex flex-col items-center gap-2 sm:gap-6 text-center transition-transform duration-200 ease-out"
      style={{
    ...
    >
      <div className="relative group">
        ...
        <div className="relative size-20 sm:size-40 overflow-hidden rounded-full border-4 border-white/50 bg-secondary shadow-[0_20px_50px_oklch(0.72_0.18_350_/_0.2)] transition-transform duration-500 group-hover:scale-105">
          {avatarError ? (
      ...
      <div className="flex flex-col items-center gap-2">
        <h1 className="text-2xl sm:text-6xl font-black tracking-tighter text-balance">
          ramochka<span className="text-primary">_</span>
        </h1>
        <div className="relative max-w-[280px] px-3 py-0.5 sm:px-4 sm:py-1 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
